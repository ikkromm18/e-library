<div class="bg-surface p-6 rounded-lg shadow border border-border space-y-6">
    ...
    <div class="overflow-x-auto border border-border rounded-lg">
        <table class="w-full text-sm text-left text-text-primary">
            ...
            {{-- 
                PENTING: HTML table tidak memperbolehkan <tr> nested di dalam <tr>.
                Solusinya: gunakan <tbody x-data> per siswa sebagai scope Alpine.js,
                lalu dua <tr> (row utama + row expand) dijadikan sibling di dalam tbody.
            --}}
            @forelse ($peminjamList as $siswa)
                <tbody x-data="{ expanded: false }" class="border-b border-border">
                    ...
                    <tr class="hover:bg-surface-muted/50 transition-colors">
                        <td class="p-3 text-center">
                            <button 
                                ...
                                class="p-1 rounded-md hover:bg-surface-muted text-text-secondary focus:outline-none"
                    ...
                    {{-- Row Expandable (sibling dari row utama, berbagi x-data dari tbody) --}}
                    <tr x-show="expanded" x-cloak class="bg-surface-muted/30">
