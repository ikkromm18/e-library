<div wire:preserveScroll>
    <div class="flex justify-between items-center mb-6">
        ...
        <button wire:click="create" wire:loading.attr="disabled" class="bg-accent hover:bg-accent-hover text-white px-4 py-2 rounded-lg text-sm font-medium disabled:opacity-50 disabled:cursor-not-allowed">Tambah Rak</button>
    </div>
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 text-sm space-x-2">
                            ...
                            @if ($item->bukus_count === 0)
                                <button wire:click="delete({{ $item->id }})" wire:loading.attr="disabled" wire:confirm="Yakin hapus rak ini?" class="text-danger-fg hover:text-danger-fg disabled:opacity-50">Hapus</button>
                            @endif
                        </td>
                    </tr>
                @empty
